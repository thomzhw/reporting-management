...
(function (e) {
    ...
    function A(a, b, c) {
        for (var f = [], h = 0, g = a.childNodes.length; h < g; h++) 1 == a.childNodes[h].nodeType && f.push(a.childNodes[h]);
        b = f[b];
    ...
    e.fn.dataTableExt.oApi.fnColReorder = function (a, b, c, f, h) {
        ...
        if (b != c)
            if (0 > b || b >= k) this.oApi._fnLog(a, 1, "ColReorder 'from' index is out of bounds: " + b);
            else if (0 > c || c >= k) this.oApi._fnLog(a, 1, "ColReorder 'to' index is out of bounds: " + c);
            else {
                var l = [];
                var d = 0;
                for (g = k; d < g; d++) l[d] = d;
                ...
                d = 0;
                for (g = k; d < g; d++) (n = a.aoColumns[d]), "number" == typeof n.mData ? (n.mData = q[n.mData]) : e.isPlainObject(n.mData) && (p(n.mData, "_", q), p(n.mData, "filter", q), p(n.mData, "sort", q), p(n.mData, "type", q));
                if (a.aoColumns[b].bVisible) {
                    ...
                    d = 0;
                    for (g = a.aoData.length; d < g; d++) null !== a.aoData[d].nTr && A(a.aoData[d].nTr, p, m);
                }
                v(a.aoColumns, b, c);
                d = 0;
                ...
                e(a.oInstance).trigger("column-reorder.dt", [a, { from: b, to: c, mapping: q, drop: f, iFrom: b, iTo: c, aiInvertMapping: q }]);
            }
    };
    var r = function (a, b) {
    ...
    r.defaults = { aiOrder: null, bEnable: !0, bRealtime: !0, iFixedColumnsLeft: 0, iFixedColumnsRight: 0, fnReorderCallback: null };
    r.version = "1.5.3";
...
(function (c) {
    "function" === typeof define && define.amd
        ? define(["jquery", "datatables.net-dt", "datatables.net-colreorder"], function (a) {
