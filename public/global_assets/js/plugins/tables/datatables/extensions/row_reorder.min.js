    ...
    a.extend(h.prototype, {
            ...
            a(e.table().container()).on("mousedown.rowReorder touchstart.rowReorder", this.c.selector, function (c) {
                if (b.c.enable) {
                    ...
                    var d = a(this).closest("tr"),
                        f = e.row(d);
                    if (f.any()) return b._emitEvent("pre-row-reorder", { node: f.node(), index: f.index() }), b._mouseDown(c, d), !1;
                }
            });
        ...
        _mouseMove: function (b) {
            ...
            if (null === this.s.lastInsert || this.s.lastInsert !== d)
                (e = a.unique(f.rows({ page: "current" }).nodes().toArray())), d > this.s.lastInsert ? this.dom.target.insertAfter(e[d - 1]) : this.dom.target.insertBefore(e[d]), this._cachePositions(), (this.s.lastInsert = d);
            this._shiftScroll(b);
        },
        _mouseUp: function (b) {
            var e = this,
...
(function (c) {
    "function" === typeof define && define.amd
        ? define(["jquery", "datatables.net-dt", "datatables.net-rowreorder"], function (a) {
