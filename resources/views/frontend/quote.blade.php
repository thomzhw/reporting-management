  ...
  <section id="menu" class="menu">
    <div class="container" data-aos="fade-up">
      <div class="section-header">
        ...
        @if ($product_choose)
            <div class="mb-3">
                <form action="{{ route('custQuote') }}" method="get">
                    @csrf()
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleFormControlInput1" maxlength="2" name="noPesan" value="{{ $code }}">
                    </div>
                    <div class="col-lg-1">
                        <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="exampleFormControlInput1" min="{{ Carbon\Carbon::now()->format('Y-m-d') }}" max="{{ Carbon\Carbon::now()->format('Y-m-d') }}" name="tglPemesanan">
                        </div>
                    </div>
                    {{-- <div class="form-group"> --}}
